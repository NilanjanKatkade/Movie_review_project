        ...
        >
            <div className="max-w-[450px] w-full bg-black bg-opacity-75 rounded px-8 py-14 mx-auto mt-8">
                ...
                <form className="flex flex-col space-y-4" onSubmit={handleLogIn}>
                    ...
                    }} placeholder='password' className="w-full h-[50px] bg-[#333] text-white rouded px-5 text-base" />
                    {error && <p className='text-red-500'>{error}</p>}
                    <button disabled={isLoading} type='submit' className="w-full bg-[#e50914] text-white py-2 rounded text-base hover:opacity-90 cursor-pointer">Sign In</button>
                </form>
